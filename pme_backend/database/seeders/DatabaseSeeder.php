    ...
    public function run(): void
    {
        ...
        foreach ([
            ...
            [
                ...
                'content'          => '<h1>برنامج الحزب ومشروعه المجتمعي</h1><p>يركز المشروع المجتمعي على التكوين، التشغيل، التحول الرقمي، العدالة الاجتماعية، مشاركة الشباب، والفعالية المؤسساتية.</p><h2>التواصل الرقمي الذكي</h2><p>تدعم المنصة ربط المنشورات بمواقع التواصل الاجتماعي بشكل أوتوماتيكي، مع ربط المجيب الذكي بالموقع لتوجيه الزوار والمنخرطين نحو المعلومات والخدمات المناسبة.</p>',
